...
class SpectraMacroWriter:
    def __init__(self, particle="proton", max_energy=100, quantity="MeV", bin_size=1, box_size=(15, 25, 175),
                 n_voxels=(1, 1, 175),
                 translate_xyz=(0., 0., 0.)):
        """
    ...
    def body(self, value):
        ...
        bins = np.linspace(0, max_energy, nbins)

        bins_pairs = []
        for i in range(len(bins) - 1):
            bins_pairs.append((round(bins[i]), round(bins[i + 1])))
    ...
    def header(self, value):
        ...
        self._header = "#the energy deposition in the phantom\n" \
